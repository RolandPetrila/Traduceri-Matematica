...
(function (root) {
  ...
  var INTERACTIVE_CSS =
    ".numere-sheet { background:#fff; color:#111; border-radius:10px; padding:16px; margin:0 auto; max-width:100%; overflow:auto; font-family:'Atkinson Hyperlegible', ui-rounded, 'Segoe UI', system-ui, sans-serif; }\n" +
