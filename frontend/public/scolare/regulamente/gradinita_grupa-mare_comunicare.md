# Regulament de generare — Grădiniță, Grupa Mare, Comunicare (DLC)

> Sursă conținut: reguli proprii (folder Carla, Grădiniță) + aliniat la Curriculum pentru educația timpurie OMEN 4694/2019 (Domeniul D — Dezvoltarea limbajului, a comunicării și a premiselor citirii și scrierii). Copii 5-6 ani.
> **ATENȚIE CRITICĂ:** deși Grupa Mare e ultima treaptă înainte de Clasa Pregătitoare, NU se introduc literele MICI de tipar, citirea independentă a unei propoziții sau scrierea de mână — acest prag rămâne STRICT al Clasei Pregătitoare (regulament separat, deja livrat: `primar_clasa0_comunicare-lb-romana.md`). La Grupa Mare, analiza propoziției rămâne STRICT orală.
> Curriculumul oficial prezintă UN SINGUR nivel „preșcolar (3-6 ani)" combinat pentru Domeniul D (fără separare pe grupe, verificat direct din documentul oficial edu.ro, pag. 21-22); comportamentele de mai jos sunt cele de FINAL de ciclu preșcolar (D.1-D.3), atinse gradual, cu Grupa Mare cea mai aproape de nivelul-țintă.
...
6. „Desparte în silabe cuvântul FLU-TU-RA-Ș și numără silabele."

## Interdicții explicite

- NU se cere scrierea de mână a cuvintelor sau propozițiilor — analiza propoziției rămâne STRICT orală, cu sprijin vizual (jetoane, puncte).
- NU se introduc literele MICI de tipar sau citirea independentă a unui text — acestea aparțin Clasei Pregătitoare.
- NU se introduc grupurile de litere ce, ci, ge, gi, che, chi, ghe, ghi în sarcini de completare/descifrare — rămân pentru Clasa Pregătitoare/Primar.
- NU se amestecă altă materie (Matematică, Educație Plastică, Practică, Cunoașterea Mediului) în aceeași fișă.
