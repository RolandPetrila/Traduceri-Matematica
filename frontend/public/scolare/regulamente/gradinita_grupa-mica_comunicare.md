# Regulament de generare — Grădiniță, Grupa Mică, Comunicare (DLC)

> Sursă conținut: reguli proprii (folder Carla, Grădiniță) + aliniat la Curriculum pentru educația timpurie OMEN 4694/2019 (Domeniul D — Dezvoltarea limbajului, a comunicării și a premiselor citirii și scrierii). Copii 3-4 ani.
> Curriculumul oficial prezintă UN SINGUR nivel „preșcolar (3-6 ani)" combinat pentru Domeniul D (fără separare pe grupe Mică/Mijlocie/Mare, verificat direct din documentul oficial edu.ro, pag. 21-22). Progresia pe grupe de mai jos e o concretizare pedagogică standard, graduală, cu limita superioară dată de regulamentul deja livrat al Clasei Pregătitoare (`primar_clasa0_comunicare-lb-romana.md`), care introduce literele MICI de tipar și scrierea elementelor grafice — acestea NU apar încă la Grupa Mică.
...
- NU citire de cuvinte sau propoziții (decodare) — doar recunoaștere vizuală globală a literei/cuvântului familiar.
- NU scriere de mână (cursivă) — doar trasare de contur mare, gros, pe repere punctate.
- NU identificarea sunetului de mijloc sau final — la Grupa Mică se lucrează STRICT cu sunetul inițial.
- NU mai mult de 4 litere/cuvinte noi pe aceeași fișă (evită suprasolicitarea la 3-4 ani).
- NU se amestecă altă materie (Matematică, Educație Plastică) în aceeași fișă.
