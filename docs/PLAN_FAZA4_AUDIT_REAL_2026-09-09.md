...
3. [ ] Istoric — seed rapid via Convertor (2-3 conversii reale) → audit „Istoric conversii"
       complet; „Istoric traduceri" doar dacă există date legacy reale, altfel ⬜ documentat.
