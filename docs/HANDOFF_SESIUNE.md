...
- [~] **F4** — sub-fazat:
  ...
  - [x] **F4d Pagini A4** ✅ 2026-07-24: foaia desktop la metrici A4 REALE (210mm, 20/18mm) = identice cu documentul exportat → ghidajele „Pagina N" cad exact unde se rupe PDF-ul; contor „📄 N pag. A4". Pe mobil foaia rămâne fluidă → ghidaje+contor ASCUNSE (ar minți). Verificat LIVE.
