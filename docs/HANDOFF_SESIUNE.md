...
- ➡️ **URMĂTORUL PAS: deploy R1 pe prod** (bump `CACHE_VERSION` v20→v21, cu confirmarea Roland) → eyeball Roland pe telefon. Apoi **PASUL 3 = R3 (OMML→LaTeX)** — vizibil ca bug în editor („Fie multimile ," fără mulțimi). ⚠️ Advisor: liniile 277-422 din acest HANDOFF necitite integral (secțiuni istorice); grep înainte de lucru care le atinge.
