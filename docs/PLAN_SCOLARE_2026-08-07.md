...
| **F4** | ✅✅ **LIVRAT (2026-08-08)** — Grădiniță, TOATE domeniile (DLC/DS/DEC/DOS + Cunoașterea Mediului), 12 noduri, schema dual-shape „domeniu" verificată; verificare la sursă OMEN 4694/2019 cu 5 subagenți pe domeniu; LIVE 6/12; NEDEPLOYAT | M                      |
...
> **🔮 SCOPE REVIZUIT (Roland, 2026-08-08, după F3 deployat) — vezi PLAN_DECISIONS D52:** acoperire cu TOATE materiile/domeniile DOAR pt **Grădiniță + Primar 0-4**. Primar 0-4 = **DEJA FĂCUT (F3)**. Grădiniță = **DEJA FĂCUT (F4, 2026-08-08)**. Gimnaziu + Liceu = **doar Matematică deocamdată** (F1 gimnaziu mate gata). → **Coada C consumată integral pt scope-ul curent** (F3+F4 gata); rămâne doar deploy-ul F4 (v48, cu confirmarea Roland) + extinderea Cl.5-12 non-mate, la cerere explicită viitoare.
>
...
| ---------- | ------------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-08-08 | **F4 LIVRAT** | ✅✅        | Grădiniță, TOATE domeniile — 12 regulamente proprii `public/scolare/regulamente/gradinita_grupa-{mica,mijlocie,mare}_*.md` (3+4+5 noduri) + `regulament_ref`+`capitole` pe cele 12 noduri din `curriculum/gradinita.ts`. **Sursare verificată la sursă cu 5 subagenți paraleli organizați PE DOMENIU** (nu pe grupă — ales explicit ca să prindă inconsistențe de progresie Mică→Mijlocie→Mare), contra Curriculum pentru educația timpurie OMEN 4694/2019 (link corect găsit după 404 pe `sursa_url` original: `edu.ro/sites/default/files/Curriculum%20ET_2019_aug.pdf`, `data_extragere` 2026-08-08). **Descoperire structurală:** documentul oficial NU are tabele de conținuturi numerice per grupă (spre deosebire de Primar/Gimnaziu) — un singur nivel „preșcolar 3-6 ani" pe 5 domenii comportamentale (A-E); progresiile per grupă (1-5→1-7→1-10 etc.) sunt concretizări pedagogice, documentate explicit ca atare. **Corecție critică (mai strictă decât Carla):** interdicție ABSOLUTĂ pe ecuații „+/-/=" la toate grupele; „corpul omenesc" la Cunoașterea Mediului limitat la părți vizibile+organe de simț, gardă mai strictă decât F3. 5 fișe construite integral de la zero (Carla fără exemple). **Gate `tsc 0 · jest 254/254 (+12) · build OK`** (1 test stale corectat — `describeGroundedCoverage` include acum „Grădiniță"). **LIVE 6/12 noduri** (`scratchpad/f4_live.mjs`): 0 scurgeri, 0 runaway rezidual, `verifyArithmetic` replicat 0 fals-pozitive pe text complet inclusiv barem — gărzile critice au ținut. **Advisor** a prins 3 lucruri: `verifyArithmetic` lipsea din script (rulat, 0 probleme), regex scurgere prea slab (întărit), `sursa_url` mort (reparat). Reziduuri: LIVE 6/12; NEDEPLOYAT. |
