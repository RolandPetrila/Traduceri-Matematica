...
| **Azure Document Intelligence** | `AZURE_DOC_INTEL_KEY` (+`_2`, +`_ENDPOINT`) | **500 × 2 = 1000 pagini/lună** (layout HQ: tabele/figuri) | ⬜ necablat (memoria R7 îl documentează ca excelent) |
