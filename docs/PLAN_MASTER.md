...
- [x] R3.6 Gate: `tsc 0 · jest 102/102 · build OK` + **eyeball LIVE pe `test.multimi2.docx`**: 20 formule la locul lor, banner corect, 0 overflow (screenshot). Export PDF: `editor.getHTML()` conține cele 20 `data-latex` (sursa export-urilor, dovedit identic la F9) → compararea perceptuală cu `Downloads/*.pdf` = eyeball Roland pe prod (mecanica dovedită)
