...
- [x] **Upgrade Next.js 14->15** — branch `chore/next-upgrade` (2026-07-08, commit f2472f5, pushed, **NEmergeuit**) — rezolva vuln npm audit **HIGH** (Next.js) FARA React 19: `next@15.5.20` + React 18.3.1 pastrat, suprafata breaking minima. Ramas doar 1 moderate postcss (bundle intern Next, build-time, neglijabil; s-ar curata la Next 16). Gate: tsc 0, jest 10/10, next build OK (10 rute). **Decizia Roland: merge in faza-g-editor** (optional dupa un preview deploy Vercel al branch-ului).
