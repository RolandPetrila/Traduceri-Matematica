...
| 1 | DeepL + toggle limba | Render: traduce poza, apesi SK/EN, verifici diacritice | `/health` |
...
| 6 | Tot proiectul | Test complet Render + local | `/audit_full` |

## Comenzi /slash utile:

```
/status          — Vezi sprint curent, ce e complet
/health          — Dupa deploy: verifica Render API
